...
async function start(){
  ...
  <button class="tab nav" aria-label="Open showcase navigation" title="Showcase navigation">↖</button><button class="tab inspect" aria-label="Inspect current FIELD context" title="Inspect selection / field / route">◎</button>
  ...
  const tab=sh.querySelector('.tab.nav'),inspect=sh.querySelector('.tab.inspect'),panel=sh.querySelector('.panel');
