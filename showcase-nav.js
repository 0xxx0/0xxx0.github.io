...
async function start(){
  ...
  .foot{padding:8px 10px;color:#69757c;font-size:8px;border-top:1px solid #29343a}.family{display:block;border-top:1px solid #29343a;text-align:left;color:#9ba6ac}.meta{display:flex;border-top:1px solid #29343a}.meta a{flex:1;padding:7px 10px;color:#7f8b92;text-decoration:none;font-size:8px}.meta a+a{border-left:1px solid #29343a}.meta a:hover{color:#eef1ed}
  </style>
  ...
  <nav class="panel" aria-label="Showcase route">
    ...
    <div class="meta"><a href="/showcase-manifest.json">MANIFEST</a>${route.receipt?'<a href="'+route.receipt+'">RECEIPT</a>':''}</div>
