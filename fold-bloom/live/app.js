...
function drawCourseMap(force=false){
  ...
  // AUDIO MAP is already the authority: this is only a compact projection of its measured energy/flux.
  if(frames.length>1){
...
syncRideProfile();syncLayerUI();refreshVault();drawCourseMap(true);update();
