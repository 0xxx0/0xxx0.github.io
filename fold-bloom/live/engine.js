export const VERSION = 'FOLD_BLOOM_LIVE_0.5';
export const N = 12;
...
export function restore(x) {
  if (!x || !['FOLD_BLOOM_LIVE_0.1','FOLD_BLOOM_LIVE_0.2','FOLD_BLOOM_LIVE_0.3','FOLD_BLOOM_LIVE_0.4',VERSION].includes(x.schema) || !Array.isArray(x.cells) || x.cells.length !== N) return null;
