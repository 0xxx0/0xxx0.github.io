export const VERSION = 'FOLD_BLOOM_LIVE_0.9';
export const N = 12;
...
export function restore(x) {
  if (!x || !['FOLD_BLOOM_LIVE_0.1','FOLD_BLOOM_LIVE_0.2','FOLD_BLOOM_LIVE_0.3','FOLD_BLOOM_LIVE_0.4','FOLD_BLOOM_LIVE_0.5','FOLD_BLOOM_LIVE_0.6','FOLD_BLOOM_LIVE_0.7','FOLD_BLOOM_LIVE_0.8',VERSION].includes(x.schema) || !Array.isArray(x.cells) || x.cells.length !== N) return null;
