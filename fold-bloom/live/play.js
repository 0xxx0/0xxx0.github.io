...
function injectStyle(){
  ...
  .fbFormTitle{font:800 8px/1.4 ui-monospace,monospace;letter-spacing:.09em}.fbFormTitle b{font-size:12px}.fbFormLines{display:grid;grid-template-columns:repeat(6,1fr);gap:4px;margin:8px 0}.fbFormLine{border:1px solid rgba(255,255,255,.11);padding:6px 2px;font:900 11px/1 ui-monospace,monospace}.fbFormLine small{display:block;margin-top:4px;font-size:6px;color:rgba(255,255,255,.45)}.fbFormNow .fbFormLine.hit{background:#fff;color:#05070b}.fbFormLegend{font:7px/1.45 ui-monospace,monospace;letter-spacing:.06em;color:rgba(255,255,255,.48)}
