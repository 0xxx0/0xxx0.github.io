...
function injectEntry(){
  ...
  box.innerHTML='<div class="law"><b>ONE MOVE:</b> TURN → PREDICT → MATCH CALL → RELEASE.<br><b>WIN A RUN:</b> hit 6 of 8 calls. Every release changes the road, even a miss.<br><span style="color:rgba(255,255,255,.48)">ROAD: measured BEAT / PHRASE / SECTION terrain; your releases deform it.<br>PUZZLE teaches shortest paths · TWO DIAL teaches relations · ECOLOGY teaches inheritance.</span><br><a href="../../foundry/axial/fan8-print.svg" target="_blank" rel="noopener" style="display:inline-block;margin-top:7px;color:#dce3ea;text-decoration:none;border-bottom:1px solid rgba(255,255,255,.28)">FAN/8 · PRINT PHYSICAL CONTROLLER ↗</a></div><div class="modes"><button data-play-mode="PLAY">RUN · HIT 6 / 8</button><button data-play-mode="PUZZLE">PUZZLE · SHORTEST PATH</button><button data-play-mode="DUET">TWO DIAL · RELATIONS</button><button data-play-mode="GARDEN">ECOLOGY · INHERIT</button><button data-play-mode="ZEN">ZEN · FREE</button></div>';
