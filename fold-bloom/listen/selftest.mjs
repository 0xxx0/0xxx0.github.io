...
console.log(JSON.stringify({ok,previewFrames:preview.frames.length,bpm:map.bpm,confidence:map.tempoConfidence,beats:map.beats.length,frames:map.frames.length,sections:map.sections.length,scopeOk,pulseOk,gestureOk,degenerateOk,beatWindow,phraseWindow,frozen,scrubA,scrubB}));
