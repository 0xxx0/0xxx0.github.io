...
export function createFieldPulse(source,opt={}){
  ...
  if(typeof globalThis.addEventListener==='function')globalThis.addEventListener('field-pulse',onLocal);
  ...
  function close(){
    ...
    try{globalThis.removeEventListener?.('field-pulse',onLocal)}catch(_){}
  }
