(function(root,factory){
  ...
  function polar(cx,cy,r,a){return[Number(cx)+Math.cos(Number(a))*Number(r),Number(cy)+Math.sin(Number(a))*Number(r)]}
  ...
  return Object.freeze({
    VERSION,TAU,clamp,wrap,circularDelta,circularDistance,nearestEquivalent,polar,
