...
function attach(api,options={}){
  ...
  function render(){
    ...
    stack.querySelectorAll('[data-remove-lens]').forEach(b=>b.onclick=()=>{api.applyLens?.(b.dataset.removeLens);mark('LENS_REMOVE_'+b.dataset.removeLens);render()});
