...
#fieldLiveBridge button,#fieldLiveBridge input,#fieldLiveBridge a{font:inherit;border:1px solid #817c72;background:transparent;color:inherit;padding:5px 7px;text-decoration:none;border-radius:0}
...
.fl-gate{background:#eee7d9}.fl-handoff{border-bottom:1px solid #191915;background:#f0eadf}.fl-portbar{display:flex;gap:5px;flex-wrap:wrap;padding:7px 9px}.fl-portbar a{font-size:8px}.fl-foot{display:flex;justify-content:space-between;gap:8px;align-items:center;padding:6px 9px;border-top:1px solid #191915}.fl-error{padding:8px 9px;color:#a8422d}
