...
if(exists('poetry/map/index.html')){
  ...
  for(const token of ['POEM MAP 0.2.5','id="fieldNowBtn"','id="focusWheel"','id="pmAperture"','id="guideBtn"','id="importBtn"','id="corpusBtn"','id="formDetails"','id="mapLawDetails"','id="carryRead"','id="carryLab"','id="carryStudy"','readfield.handoff.v1','field.verse.handoff.v01','verse.atlas.handoff.v01','poemReturnAddress','restoreReturnFocus','bootFocus','bootSourceKey','source_key','candidateOperation','candidateEdit','INSERT_AFTER','data-mode="PAGE"','data-mode="MAP"','data-mode="SETS"','ORDER','SOUND','REPEAT','AUTHOR','APERTURE','TRY','ADOPT','LOCK'])check(p.includes(token),'Poem Map capability token missing: '+token);
