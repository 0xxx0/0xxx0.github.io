...
check(workfieldJs.includes("selected&&(selected.status!=='done'||selected.sourceLink)")&&workfieldJs.includes("RETURN_RELEASE"),'Dayline completed source object no longer survives through RETURN/release');
