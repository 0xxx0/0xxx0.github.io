...
check(home.includes('id="apInspect"')&&home.includes('>READ</button>'),'FIELD root missing READFIELD focus action');
...
check(home.includes('id="axialLatest"'),'root missing unified FIELD focus surface');
