...
check(daylineApp.includes("atlas-dayline-hermes-handoff/v0.1")&&daylineApp.includes("authority:'NONE'")&&daylineApp.includes("USER_EXPLICIT_COPY"),'Atlas Dayline handoff lost bounded authority markers');
check(daylineBridge.includes('COPY HANDOFF')&&daylineBridge.includes("api().snapshot()")&&daylineBridge.includes('fl-compact'),'Atlas Dayline LIVE mobile reality bridge regressed');
...
check(daylineSw.includes("atlas-dayline-i-v3"),'Atlas Dayline service worker cache version not bumped for mobile reality release');
