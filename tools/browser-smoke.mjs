...
const CASES=[
  ...
  },
  {
    ...
    route:'/fold-bloom/',
    check:dom=>/FOLD ?\/\/ ?BLOOM/i.test(dom)&&/FOLD WEAVE 0\.1/i.test(dom)&&/GLYPH ATLAS 0\.2/i.test(dom)&&/LISTEN 0\.6/i.test(dom)&&/LIVE 0\.11/i.test(dom)&&/TWO DIAL 0\.10\.3/i.test(dom)&&/href="\.\/ecology\/"/i.test(dom)
  },
  {
  ...
  {
    name:'FOLD BLOOM LIVE 0.11 macro drop',
    route:'/fold-bloom/live/',
    options:{width:430,height:900,budget:9000},
    check:dom=>/LIVE 0\.11/i.test(dom)&&dom.includes('data-fold-bloom-live="ready"')&&dom.includes('data-fold-bloom-pov="embodied-v0.2"')&&dom.includes('data-fold-bloom-macro-drop="v0.1"')&&dom.includes('data-fold-bloom-idle-law="witness-v0.1"')&&dom.includes('data-fold-bloom-idle="on"')&&dom.includes('data-fold-bloom-landmarks="0"')&&dom.includes('id="demoBtn"')&&dom.includes('id="call"')&&dom.includes('id="arc"')&&dom.includes('id="route"')&&dom.includes('id="trackFile"')&&dom.includes('id="lyric"')&&dom.includes('id="textBtn"')&&/IDLE RIDE/.test(dom)&&/BEAT \/ PHRASE \/ SECTION/i.test(dom)&&/FIELD COURSE/.test(dom)&&/same left\/right turn/i.test(dom)&&dom.includes('data-trackfield-source="FIELD_PRACTICE"')&&/data-trackfield-motion="(?!NONE)[^"]+"/.test(dom)  },
  {
