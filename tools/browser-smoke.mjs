  ...
  },
  {
    ...
    check:dom=>{
      const parts={
        ...
        pulseTrainer:dom.includes('id="pulseTarget"')&&dom.includes('id="pulseError"')&&dom.includes('id="pulseBias"')&&dom.includes('id="pulseJitter"')&&dom.includes('id="pulseCorr"')&&dom.includes('id="pulseTrainReset"')&&dom.includes('data-field-lab-pulse-psychophysics="FOLD_BLOOM_PULSE_PSYCHOPHYSICS_0.2"')&&dom.includes('data-field-lab-pulse-train="LOCK"')&&dom.includes('data-field-lab-pulse-target="M"')&&dom.includes('data-field-lab-pulse-rings="3"')&&dom.includes('data-field-lab-pulse-focus="AUTO"')&&dom.includes('data-pulse-rings="1"')&&dom.includes('data-pulse-rings="2"')&&dom.includes('data-pulse-rings="3"')&&dom.includes('data-pulse-focus="AUTO"')&&dom.includes('data-pulse-focus="M"')&&dom.includes('data-pulse-focus="A"')&&dom.includes('data-pulse-focus="B"'),
        voiceFold:dom.includes('id="voiceTrain"')&&dom.includes('id="voiceFull"')&&dom.includes('id="voiceMic"')&&dom.includes('id="voiceSpectrum"')&&dom.includes('data-field-lab-voice="ready"'),
