...
test('PASS receipt with verification text that still says CI pending is detected', () => {
  const receipt = {
...
test('pending state and proof claims are detected regardless of field shape', () => {
